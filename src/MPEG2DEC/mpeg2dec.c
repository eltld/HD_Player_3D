...
//===========================================================================
//unsigned char Dec_Buffer[720*360*3];
unsigned char Dec_Buffer[720*2880*3];
unsigned char Dec_Buffer_[1920*1024*3];
BOOL volatile Decoding;
int Decoded_Num;
//===========================================================================
...
static void Clear_Options_GDX();

#ifdef DEBUG
static void Print_Options();
#endif

int main(argc,argv,InputFilePath,OutputBuffer)
int argc;
char *argv[];
char * InputFilePath;
...
//  Clear_Options();
  //==============================================自己做的解码设置
  Clear_Options_GDX();
  Main_Bitstream_Filename=InputFilePath;
  //==============================================自己做的解码设置
...
int *Bitstream_Framenumber;
{
  ...
  {
    Output_Last_Frame_of_Sequence(Bitstream_Framenum);//==============================在这里调用 层层函数 直到store_ppm_tga
  }
...
{
	Verbose_Flag = 0;//
	Output_Type = 2;// 0:YUV 1:SIF 2:TGA 3:PPM
	hiQdither  = 0;//
	Frame_Store_Flag = 1;//
	Spatial_Flag = 0;//
	Reference_IDCT_Flag = 1;//
	...
	//====================================这里要改成 由调用dll的程序提供输入
	//加到主函数一开头了
	//Main_Bitstream_Filename = "D:\\My Documents\\Visual Studio 2008\\Projects_Test_201005\\hehua_ 720360_1.mpg";
	//Main_Bitstream_Filename=InputFilePath;
	//====================================这里要改成 由调用dll的程序提供输入

	Output_Picture_Filename = "D:\\My Documents\\Visual Studio 2008\\Projects_201005_1\\Mpeg2_Dec_\\Mpeg2_Dec_%d";
	Lower_Layer_Picture_Filename = " ";
	Substitute_Picture_Filename  = " ";
	Enhancement_Layer_Bitstream_Filename = " ";
}
